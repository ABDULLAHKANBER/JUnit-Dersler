...
public class C02_JSAlerts extends TestBaseBeforeClass {
    ...
    public void test02() throws InterruptedException {
        ...
        Assert.assertTrue(expectedSonucYazisi.contains(actualSonucYazisi));
        Thread.sleep(3000);
    ...
    public void test03() throws InterruptedException {
        ...
        String actualSonucYazisi=driver.findElement(By.xpath("//*[text()='You entered: Abdullah']")).getText();
