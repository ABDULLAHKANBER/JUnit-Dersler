...
public class C05_Actions extends TestBase {
    ...
    public void test01(){
        ...
        WebElement accountsListMenuElementi=driver.findElement(By.xpath("//*[@class='nav-line-2 ']"));
        ...
        WebElement yourListElementi=driver.findElement(By.xpath("//*[@role='heading']"));
        String expectedYaziElementi="Your Lists";
        String actualYaziElementi=yourListElementi.getText();

        Assert.assertTrue(expectedYaziElementi.contains(actualYaziElementi));
